            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <?php 
                        ...
                        where staffs.roles = 'fyp_coordinator' order by users.id desc";
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="d-flex justify-content-end align-items-center mb-3">
                                    <a href="/fyp/register-fypcoordinator.php" class="btn btn-primary">Add FYP Coordinator</a>
                                </div>
                                            ...
                                            if( $clusters != NULL){
                                                foreach ($clusters as $key => $value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="">
                                                            <a href="edit-fyp_coordinator.php?fyp_coordinator_id='.$value['id'].'" class="btn btn-sm btn-primary">Edit</a>
                                                            <a href="controllers/hod/delete-fyp-coordinator.php?fyp_coordinator_id='.$value['id'].'" class="btn btn-sm btn-danger">Delete</a>
                                                        </td>
                                                    </tr>';
                                                }
                                            }else{
