...
INSERT INTO `staffs` (`id`, `user_id`, `roles`, `staff_id`, `department`, `created_at`, `updated_at`) VALUES
(1, 8, 'hod', '1', 'Faculty of Education & Social Sciences', NULL, NULL);
...
INSERT INTO `students` (`id`, `user_id`, `matric_number`, `programmes`, `supervisor_id`, `created_at`, `updated_at`) VALUES
(1, 7, '1', 'Foundation In Space', NULL, NULL, NULL);
...
(7, 'a', 'asd@gmail.com', '1', 'student', '1', '1671175318.jpeg', NULL, NULL),
(8, 'hh', 'asda@gmail.com', '1', 'hod', '1', NULL, NULL, NULL);
...
--
-- Indexes for table `proposal_attachment`
--
...
--
-- AUTO_INCREMENT for table `proposal_attachment`
--
ALTER TABLE `proposal_attachment`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
