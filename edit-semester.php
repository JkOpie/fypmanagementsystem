                        ...
                        <div class="row">
                            <div class="col-xxl-12 col-xl-12">
                             ...
                             <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header justify-content-center"><h3 class="fw-light my-4">Edit Semester</h3></div>
                                    <div class="card-body">
                                        <!-- Registration form-->
                                        <?php 
                                            $conn = setDbConnection();
                                            $sql = "select * from semesters where id = '".$_REQUEST['id']."'";
                                        ...
                                        ?>
                                        <form action="controllers/fypcoordinator/edit-semester.php" method="post">
                                            <!-- Form Row-->
                                            <div class="row gx-3">
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        <label class="small mb-1" >Semester</label>
                                                        <input type="text" name="name"  placeholder="Enter Semester" class="form-control" value="<?php echo $semesters[0]['name'] ?>" required>
                                                        <input type="hidden" name="id" value="<?php echo $semesters[0]['id'] ?>">
                                                    </div>
                                                </div>
                                            </div>
