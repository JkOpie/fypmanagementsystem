        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <?php
                    ...
                    $sql = "select users.* , staffs.* from users left join staffs on staffs.user_id = users.id where users.id = '".$_REQUEST['supervisor_id']."'";
                ...
                <div class="container-xl px-4 mt-4">
                    <div class="row">
                        <div class="col-xl-4">
                            ...
                            <form action="controllers/updateSupervisorPhoto.php" method="post" enctype="multipart/form-data">
                                <div class="card mb-4 mb-xl-0">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="my-3">
                                            ...
                                            <input type="hidden" value="<?php echo $_REQUEST['supervisor_id'] ?>" name="supervisor_id" >
                                        </div>
                                        <div class="my-3">
                        ...
                        <div class="col-xl-8">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="controllers/updateSupervisorProfile.php" method="post" >
